...
class MainActivity : AppCompatActivity() {
    ...
    private fun clickLemonImage() {
        ...
        //  - The lemonSize variable needs to be set using the 'pick()' method in the LemonTree c
        //  lass
        ...
        if (lemonadeState == SQUEEZE) {
            ...
            squeezeCount++
            Log.i("Squeeze Count", squeezeCount.toString())

            lemonSize--
            Log.i("Lemon Size", lemonSize.toString())
